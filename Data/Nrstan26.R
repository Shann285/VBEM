...
stan_ssp <- sampling(stan_m, data = fa.data, pars =c("inu","kap","lam","lom", "alpha_i","alpha_l", "mu_imp", "phi_imp"), chains = 3, iter = 10000, init = init_model, cores = 3, control = list(adapt_delta=0.95, max_treedepth=12))
...
save.image(paste("DataNURstan",".RData",sep=""))
